...
<h1 align="center">puppet-lint</h1>
  ...
  build:
    ...
    steps:
      ...
      - name: Run Puppet Lint
        run: bash <(curl -s https://raw.githubusercontent.com/lupaxa-cicd-toolbox/puppet-lint/master/src/pipeline.sh)
```
...
```bash
bash <(curl -s https://raw.githubusercontent.com/lupaxa-cicd-toolbox/puppet-lint/master/src/pipeline.sh)
```
